    ...
    <View style={loginStyles.root}>
      ...
      <View style={loginStyles.container}>
        ...
        <View style={loginStyles.form}>
          ...
          {errMsg.form && <Text style={labelErr}>{errMsg.form}</Text>}
          <View
            style={{ justifyContent: "space-between", flexDirection: "row" }}
          >
            {action === "login" ? (
              <TouchableOpacity onPress={() => setAction("register")}>
                <Text style={loginStyles.textLink}>Sign up</Text>
              </TouchableOpacity>
            ) : (
              <TouchableOpacity onPress={() => setAction("login")}>
                <Text style={loginStyles.textLink}>Sign in</Text>
              </TouchableOpacity>
            )}
            {action === "login" && (
              <TouchableOpacity>
                <Text style={loginStyles.textLink}>Forgot password?</Text>
              </TouchableOpacity>
            )}
          </View>
          <TouchableOpacity
